    ...
    <div class="bg-white rounded-2xl border border-slate-200 shadow-xs p-6 sm:p-8">
        <form method="POST" action="{{ route('periods.update', $period) }}" class="space-y-5">
            ...
            <div>
                ...
                <input type="number" name="due_amount" id="due_amount" value="{{ old('due_amount', $period->due_amount) }}" min="0" step="1000" placeholder="Kosongkan jika mengikuti default grup"
